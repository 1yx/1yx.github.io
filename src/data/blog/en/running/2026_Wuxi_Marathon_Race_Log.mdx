...
<FloatImage src={wuxiRunData} alt="Coros watch data screenshot from Wuxi Marathon" float="right" maxWidth="15.5rem" upperLines={1}>
...
<FloatImage src={wuxiParkLake} alt="Wuxi Bogong Island Ecological Park" float="left" maxWidth="32rem" bleed="-5rem" upperLines={1}>
...
<FloatImage src={wuxiParkSpring} alt="Xuntang Ancient Town in Wuxi" float="right" maxWidth="32rem">
...
<FloatImage src={sufficientMinimumDevelopmentSpeed} alt="段永平 足够的最小发展速度" float="right" maxWidth="12rem" collapse={false} bleed="-3rem">
