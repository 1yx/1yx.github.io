...
<FloatImage src={wuxiParkSpring} alt="Xuntang Ancient Town in Wuxi" float="right" maxWidth="2xl" collapse={false} bleed='1rem'>
...
<FloatImage src={sufficientMinimumDevelopmentSpeed} alt="段永平 足够的最小发展速度" float="right" maxWidth="12rem" collapse={false} bleed="1rem">
