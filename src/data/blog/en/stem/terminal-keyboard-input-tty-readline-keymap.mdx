...
|-------------|--------------|---------------------|-----------|
| <span title="^（caret）represents the Ctrl modifier">`^C`</span> | SIGINT | <span title="Friendly Interactive SHell — a user-friendly Unix shell">Fish</span>: cancel, Helix: normal mode | No — tools preserve **TTY** handling |
