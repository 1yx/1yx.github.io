...
export const translations = {
  "zh-CN": {
    ...
    training: {
      ...
      calendarLink: "跑步日志",
      overviewDesc:
        "2026 下半年全马训练计划——按 阶段、大周期、小周期 浏览全部训练课程。",
      dayTitle: "训练日历",
      dayDesc: "按日查看训练计划与 Strava 实际完成情况，含每公里配速。",
      mesocycleTitle: "大周期视图",
      mesocycleDesc: "按 Mesocycle 查看各 Microcycle 与每日训练安排。",
      backToOverview: "返回总览",
      backToDay: "返回日视图",
      plannedSection: "计划",
      ...
      prevDay: "前一天",
      nextDay: "后一天",
      prevMesocycle: "上一个 大周期",
      nextMesocycle: "下一个 大周期",
      phasesNav: "训练阶段",
      current: "当前",
      calendarNav: "训练日历",
      microcycleView: "周期视图",
  ...
  en: {
    ...
    training: {
      ...
      overviewDesc:
        "2026 second-half marathon training plan — browse every session by phase, mesocycle, and microcycle.",
      dayTitle: "Training Calendar",
      dayDesc: "Day-by-day view of the training plan and Strava actuals, with per-km pace.",
      mesocycleTitle: "Mesocycle View",
      mesocycleDesc: "Browse each microcycle and daily schedule within a mesocycle.",
      ...
      mesocycleLabel: "Mesocycle",
      dayLabel: "Day",
      prevDay: "Previous day",
      nextDay: "Next day",
      prevMesocycle: "Previous mesocycle",
      nextMesocycle: "Next mesocycle",
      phasesNav: "Phases",
      current: "Current",
      calendarNav: "Training calendar",
      microcycleView: "Phase",
      weeklyView: "Calendar",
      filterAll: "All",
